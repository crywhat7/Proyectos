...
<h2 class="text-center" style="font-family: monospace;">Portal</h2>
<br><br>
<div class="container">
<div class="row">
...
<div class="col-md-4 col-sm-6 col-xs-12">
	<div class="hovereffects">
		...
		<div class="overlay">
			<h2>CRUD</h2>
			<a class="info" href="Listar.jsp?clase=daw&campus=ceutec">Click para ir</a>
		</div>
	</div>
...
<div class="col-md-4 col-sm-6 col-xs-12">
	<div class="hovereffects">
		<img src="img2.png" height="300px" width="100%" alt="images">
		<div class="overlay">
			<h2>Chat en linea</h2>
...
<div class="col-md-4 col-sm-6 col-xs-12">
	<div class="hovereffects">
		<img src="img3.png" height="300px" width="100%" alt="images">
		<div class="overlay">
			<h2>Subir fotos</h2>
			<a class="info" href="#">more info</a>
		</div>
